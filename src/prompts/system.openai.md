...
- **Keep answers tight.** Sharper bound than the shared rule: a typical reply is 3–6 sentences or ≤5
  bullets, highest-value point first. Spend length on code and diffs, not prose.
